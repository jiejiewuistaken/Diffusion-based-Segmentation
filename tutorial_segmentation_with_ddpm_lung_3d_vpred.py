...
import sys
sys.path.append('/root/GenerativeModels/')
...
os.environ["MONAI_DATA_DIRECTORY"] = '/root/autodl-tmp/tmp3lryw4_b/tmp3lryw4_b' # for Task06

directory = os.environ.get("MONAI_DATA_DIRECTORY")
# directory = None
root_dir = tempfile.mkdtemp() if directory is None else directory

result_image_dir = f'/root/autodl-tmp/GenerativeModelTutorialOutput/{config["dataset"]}/3D_runs_{timestamp}/'
